...
connect_debug_port u_ila_0/probe0 [get_nets [list {u_gen/clk_cnt[0]} {u_gen/clk_cnt[1]} {u_gen/clk_cnt[2]} {u_gen/clk_cnt[3]} {u_gen/clk_cnt[4]} {u_gen/clk_cnt[5]} {u_gen/clk_cnt[6]} {u_gen/clk_cnt[7]} {u_gen/clk_cnt[8]} {u_gen/clk_cnt[9]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {uart_data0[1]} {uart_data0[2]} {uart_data0[5]} {uart_data0[6]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 5 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {uart_data__0[0]} {uart_data__0[1]} {uart_data__0[2]} {uart_data__0[5]} {uart_data__0[6]}]]
create_debug_port u_ila_0 probe

...
#
# Script generated by Vivado on Tue Jan 20 12:46:35 +0100 2026
...
#
# Usage        : mfcc_1.sh
#                mfcc_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mfcc_1.sh [-reset_run]
#                mfcc_1.sh [-reset_log]
#                mfcc_1.sh [-help]
#
...
#                script (type 'mfcc_1.sh -help' for more information).
#
...
# script info
echo -e "mfcc_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mfcc_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mfcc_1 xil_defaultlib.glbl -o mfcc_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mfcc_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mfcc_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mfcc_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mfcc_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mfcc_1.sh [-help]\n\
Usage: mfcc_1.sh [-step]\n\
Usage: mfcc_1.sh [-lib_map_path]\n\
Usage: mfcc_1.sh [-reset_run]\n\
Usage: mfcc_1.sh [-reset_log]\n\
Usage: mfcc_1.sh [-keep_index]\n\
Usage: mfcc_1.sh [-noclean_files]\n\n\

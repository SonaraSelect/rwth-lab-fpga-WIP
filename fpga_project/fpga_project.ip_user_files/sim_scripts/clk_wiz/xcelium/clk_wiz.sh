...
#
# Script generated by Vivado on Tue Dec 09 10:19:15 CET 2025
...
#
# Usage        : clk_wiz.sh
#                clk_wiz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz.sh [-reset_run]
#                clk_wiz.sh [-reset_log]
#                clk_wiz.sh [-help]
#
...
#                script (type 'clk_wiz.sh -help' for more information).
#
...
# script info
echo -e "clk_wiz.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_wiz xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_wiz -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fpga13/group_admi/fpga_project/fpga_project.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_wiz_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: clk_wiz.sh [-step]\n\
Usage: clk_wiz.sh [-lib_map_path]\n\
Usage: clk_wiz.sh [-reset_run]\n\
Usage: clk_wiz.sh [-reset_log]\n\
Usage: clk_wiz.sh [-keep_index]\n\

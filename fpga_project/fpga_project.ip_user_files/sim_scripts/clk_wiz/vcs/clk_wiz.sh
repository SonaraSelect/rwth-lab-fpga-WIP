...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fpga13/group_admi/fpga_project/fpga_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key clk_wiz_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_wiz_simv.daidir vcs_lib c.obj)

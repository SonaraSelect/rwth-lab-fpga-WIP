...
HD_PWD='/home/fpga13/group_admi/fpga_project/fpga_project.runs/impl_1/.Xil/Vivado-146488-FPGA13L/dc_drv.0/dc/prj_ip.runs/u_ila_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u_ila_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u_ila_0.tcl

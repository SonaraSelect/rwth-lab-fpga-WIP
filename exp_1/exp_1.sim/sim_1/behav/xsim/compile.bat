...
REM
REM Generated by Vivado on Tue Nov 18 13:42:24 +0100 2025
...
echo "xvlog --incr --relax -L uvm -prj mic_tests_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mic_tests_vlog.prj -log xvlog.log

...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream_TVALID { I 1 bit } in_stream_TDATA { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream_TKEEP { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream_TSTRB { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 5 \
    name abs_spectrogram \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename abs_spectrogram \
    op interface \
    ports { abs_spectrogram_address0 { O 9 vector } abs_spectrogram_ce0 { O 1 bit } abs_spectrogram_we0 { O 1 bit } abs_spectrogram_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'abs_spectrogram'"
}
}

...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mfcc_1 \
    op interface \
    ports { mfcc_1_address0 { O 6 vector } mfcc_1_ce0 { O 1 bit } mfcc_1_q0 { I 15 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_stream_TREADY { I 1 bit } out_stream_TDATA { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_stream_TKEEP { O 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_stream_TSTRB { O 2 vector } } \
} "
} else {

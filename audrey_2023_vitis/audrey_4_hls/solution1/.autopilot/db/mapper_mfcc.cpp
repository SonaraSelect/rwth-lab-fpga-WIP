...
auto* sin_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_in_stream_V_last_V);
  ...
  short* __xlx_out_stream_V_data_V_input_buffer= new short[ap_apatb_out_stream_V_data_V_cap_bc];
auto* sout_stream_V_data_V = createStream((hls::stream<short>*)__xlx_apatb_param_out_stream_V_data_V);
...
auto* sout_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_stream_V_last_V);
  // DUT call
  mfcc(sin_stream_V_data_V->data<short>(), sin_stream_V_keep_V->data<char>(), sin_stream_V_strb_V->data<char>(), sin_stream_V_last_V->data<char>(), sout_stream_V_data_V->data<short>(), sout_stream_V_keep_V->data<char>(), sout_stream_V_strb_V->data<char>(), sout_stream_V_last_V->data<char>());
sin_stream_V_data_V->transfer((hls::stream<short>*)__xlx_apatb_param_in_stream_V_data_V);
...
sout_stream_V_data_V->transfer((hls::stream<short>*)__xlx_apatb_param_out_stream_V_data_V);

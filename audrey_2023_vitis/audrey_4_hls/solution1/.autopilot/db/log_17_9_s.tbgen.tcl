...
set C_modelName {log<17, 9>}
set C_modelType { int 15 }
set C_modelArgList {
	{ x_val int 17 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "x_val", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_val", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "x_val", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_29s_6ns_29_2_1_U73", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5s_23ns_28_1_1_U74", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_9ns_9ns_18_1_1_U75", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_mulsub_24ns_4ns_29ns_29_4_1_U76", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	x_val { ap_none {  { x_val in_data 0 17 } } }
}
